...
func main() {
	...
	default:
		fmt.Println("no message sent") // message taken, message sent to chan
	}
	...
	default:
		fmt.Println("no activity") // no reads from messages or signals
	}

	// chans didn't block. program ends
}
